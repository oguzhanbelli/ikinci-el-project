  ...
  return (
    <>
      <div className="justify-center items-center flex flex-col overflow-x-hidden  overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
        <div className="relative  my-6 mx-auto w-[480px] h-[461px] ">
          {/*content*/}
          <div className="border-0 rounded-lg shadow-lg relative  dark:bg-gray-700  flex flex-col w-full  bg-white outline-none focus:outline-none">
            ...
            <div className="flex items-start justify-between  rounded-t ">
              <h3 className="text-[1.563em] mt-[20px] ml-[20px] text-[#525252] font-bold dark:text-white">
                    Teklif Ver
              </h3>
              <button
                className=" bg-transparent border-0 mt-[30px] mr-[19px] text-black opacity-100 float-right text-3xl leading-none font-semibold outline-none focus:outline-none"
            ...
            {/*body*/}
            <div className='w-full h-[461px] flex flex-col bg-white rounded-[10px]  '>
              <div className='w-[441px] h-[60px] flex flex-row bg-[#F0F8FF] mx-auto mt-[17px] rounded-[10px] '>
                <div className='w-[50px] h-[50px] mt-[6px] ml-[6px] '>
                  <img className='w-[50px] h-[50px] rounded-[8px]'  src={`${process.env.REACT_APP_BASE_ENDPOINT}${state?.image?.url}`}/>
                </div>
                <div className='mt-[8px] ml-[7px] w-[136px] h-[34px] mb-[18px] flex flex-wrap text-ellipsis overflow-hidden  '>
                  <p className='font-normal  text-[#555555] text-[0.813em]  '>{state?.name}</p>
                </div>
                <div className=' flex  items-center     w-full relative'>
                  <p className="text-[#525252]  text-[1.125em]  font-bold  absolute  right-[11px]  ">
                    {state?.price},00 TL
                  </p>
                </div>
              ...
              <form>
                ...
                <div className={`w-[441px] h-[45px]  cursor-pointer  flex flex-row ${checked ? 'bg-[#F0F8FF] border-[1px]  border-[#4B9CE2]' : 'bg-[#F0F8FF]'} mx-auto mt-[17px] rounded-[10px]`}>
                ...
                <div className={`w-[441px] cursor-pointer h-[45px] flex flex-row ${checked ? 'bg-[#F0F8FF] border-[1px] border-[#4B9CE2]' : 'bg-[#F0F8FF]'} mx-auto mt-[17px] rounded-[10px]`}>
                  <label onClick={() => setChecked(true)} className='flex items-center ml-[10px] w-full cursor-pointer peer-checked:bg-red-300 '>
                    <input type={'radio'}  value={'20'} name="offer" className="option-input radio peer" />
                    <p className={`${checked ? ' text-[#4B9CE2]':'text-[#525252]'} text-[0.938em]  font-normal ml-[5px]`}>
                ...
                <div className={`w-[441px] h-[45px] flex flex-row mx-auto mt-[15px] rounded-[10px]`}>
