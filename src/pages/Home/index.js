  ...
  return (
    <div>
      ...
      >
        ...
        <div className="flex flex-wrap hide-scrollbar  flex-row overflow-scroll w-[375px] md:justify-center lg:justify-start md:w-[690px] lg:w-[1000px]  lg:h-auto p-1  xl:w-[1500px] h-auto  xl:h-auto xl:pb-[171px] gap-[15px] xl:gap-[20px] rounded-[8px]  mt-[20px] pb-[20px] xl:mt-[20px] ">
          {!loading ? (
